        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cc)
                    .addComponent(clie)
                    .addComponent(dir_casa)
                    .addComponent(tel_casa)
                    .addComponent(dir_ofi)
                    .addComponent(tel_ofi)
                    .addComponent(correo, javax.swing.GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE))
                .addGap(50, 50, 50)
